...
sessionInfo()
sourceCpp("LATAMsinvariance.cpp")
...
alphastart=matrix(0,ncol(Y)),
alphastart_conv= matrix(0,ncol(Y)),
alphastart_unconv=matrix(0,ncol(Y)),
...
save(Results, file="Results_ScalarinvarianceModel")
