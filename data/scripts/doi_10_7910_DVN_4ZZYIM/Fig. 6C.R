...
setwd("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.549")

tree<-read.newick('~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.549/timetree.nwk')
...
metadata_df <- read.csv("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.549/meta_globe+Ken_subsampleone_B.1.549_wave2.csv")%>%
...
pdf("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.549/Fig.6C.pdf", width = 3.5, height = 4)
print(global_tre)
dev.off()
