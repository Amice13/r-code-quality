...
setwd("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.1/")

tree<-read.newick('~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.1/timetree.nwk')
...
metadata_df <- read.csv("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.1/meta_globe+Ken_subsampleone_B.1.1_wave2.csv")%>%
...
global_tre <-  p%<+% metadata_df+ 
  ...
  scale_y_continuous(limits=c(0,1700), minor_breaks = seq(0 , 1700, 200), breaks = seq(0 , 1700, 400))+
...
pdf("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.1/Fig.6F.pdf", width = 3.5, height = 4)
print(global_tre)
dev.off()
