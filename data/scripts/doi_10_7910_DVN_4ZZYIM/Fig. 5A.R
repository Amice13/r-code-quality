...
setwd("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.5/")

tree<-read.newick('~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Data/subsampled_global/subsampleone/ggtree/timetree.nwk')
...
metadata_df <- read.csv("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Data/subsampled_global/subsampleone/ggtree/meta_globe+Ken_subsampleone_wave2.csv")%>%
...
recent_date <- format(date_decimal(2021.153), "%Y-%m-%d")
recent_date
...
pdf("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.5/Fig.5A.pdf", width = 3.5, height = 10)
print(global_tre)
dev.off()
