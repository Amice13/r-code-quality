...
# Load pstats -------------------------------------------------------------
source(here("sim_study_settings.R"))
source(here("pl_fd_methods.R"))
...
ggsave(here("figures", paste0(scenario_n, "_histogram.pdf")), width = 4000, height = 4000, units = "px", device = cairo_pdf)
...
ggsave(here("figures", paste0(method, "_dr_histogram.pdf")), width = 4000, height = 5500, units = "px")