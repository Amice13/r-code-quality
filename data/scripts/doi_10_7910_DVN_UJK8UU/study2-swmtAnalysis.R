...
raw_gender_data = read.csv("2025.01.04 - swmt data.csv")
...
extended_vars = c("gender.f", "cmni27", "cmni43", "cmni41", "cmni24", "cmni8", "cmni25", "cmni36", "GGI_young", "GGI_now", "log10_age", "score", "country_young", "country_now")
...
country_young_count <- count(extended_binary_and_nonbinary_gender_data, "country_young")
country_now_count <- count(extended_binary_and_nonbinary_gender_data, "country_now")
write.csv(extended_binary_and_nonbinary_gender_data, "swmt-extended_binary_and_nonbinary_gender_data.csv")
...
# Table 9 and the accompanying diagram
...
print("Gender+CMNI+GGI to gender")
print(anova(m_gender, m_gender_cmni_ggi))
...
## ********** Table 8: Multiple Mediation Analysis
print("******* MMA ANALYSIS ************")
library("mma")
