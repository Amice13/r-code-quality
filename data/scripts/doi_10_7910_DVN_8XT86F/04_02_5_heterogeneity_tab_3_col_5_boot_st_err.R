...
#
#                             Replication scripts
#               Table 3 Column 5 Bootstrapped Standard Errors
...
load("heterogeneity_estimates.rda")
...
boot_het_estimates <- boot(object = het_estimates[[5]], 
                           hypothesis = "het_l", 
                           group = db$id_2, 
...
# print results column 5 table 3
boot_het_estimates
