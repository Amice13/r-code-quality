...
write.csv(out.m, 'output/lagged-vote-model-county-coefficients-weighted.csv')
...
write_csv(scatter_out,'output/lagged-vote-county-weighted-state-scatter.csv')
...
write.csv(holder, 'results/lagged-vote-model-county-stats-weighted.csv')
