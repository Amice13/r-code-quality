...
# regions: 1 = central, 2 = kilifi, 3 = kwale, 4 = mombasa, 5 = coast other, 
# 6 = machakos, 7 = eastern/north eastern, 8 = nairobi, 9 = kisumu, 
# 10 = nyanza other,  11 = uasin gishu, 12 = rift valley other, 13 = western

dat <- read.csv("stratum_level_data_regions13.csv")
nr <- 13
na <- 5
ns <- 2
