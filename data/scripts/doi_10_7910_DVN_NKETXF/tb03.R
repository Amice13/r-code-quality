...
# alc
nns_alc <- nns(x = trump_alc_agg, N = 10, candidates = trump_alc_agg@features, pre_trained = pre_trained, stem = FALSE, as_list = TRUE)

# Embeddings
nns_emb <- nns(x = trump_embeds_agg, N = 10, candidates = trump_embeds_agg@features, pre_trained = pre_trained, stem = FALSE, as_list = TRUE)
