...
Att_Attendance_Unconditional_NT <- att_gt(yname = "Attendance", 
                                          ...
                                          panel = TRUE) 
Attendance_agg_Unconditional_NT <- aggte(Att_Attendance_Unconditional_NT, type = "group")

stargazer(results(Attendance_agg_Unconditional_NT),summary=F,type="text", out="TableA3.htm")
