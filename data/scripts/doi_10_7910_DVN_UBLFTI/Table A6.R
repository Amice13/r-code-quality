...
Att_Attendance_Conditional <- att_gt(yname = "Attendance", 
                                     ...
                                     panel = TRUE) 
Attendance_agg_Conditional <- aggte(Att_Attendance_Conditional, type = "group")

stargazer(results(Attendance_agg_Conditional),summary=F,type="text", out="TableA6.htm")