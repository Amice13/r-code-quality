...
# Data Output: Data/Derived/2012/AP12-4-Compare_New_and_Old.RData
# NOTES: Input data created in 'Analysis\AP12-3-DIF.R'
#
...
compare_nested_12 <- dif_nested_12  %>%
  # DOES SCALE SHOW DIF?
...
save(compare_nested_12, file = "Data/Derived/2012/AP12-4-Compare_New_and_Old.RData")
...
qplot(compare_nested_12$cor, geom = "histogram")
