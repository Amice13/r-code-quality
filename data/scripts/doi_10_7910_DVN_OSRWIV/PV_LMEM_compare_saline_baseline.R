...
PV_values.model= lmer (PV_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date), data=PV_values, REML=FALSE)
anova(
  PV_values.model,
...
par(mfrow=c(1,3))
PV_values.model= lmer (PV_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date), data=PV_values, REML=TRUE)
...
sjPlot::plot_model(PV_values.model, title = "PV_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date)")
sjPlot:: tab_model(PV_values.model, title = "PV_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date)",
