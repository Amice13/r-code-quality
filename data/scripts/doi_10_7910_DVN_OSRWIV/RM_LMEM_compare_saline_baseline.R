...
RM_values.model= lmer (RM_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date), data=RM_values, REML=FALSE)
anova(
  RM_values.model,
...
par(mfrow=c(1,3))
RM_values.model= lmer (RM_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date), data=RM_values, REML=TRUE)
...
sjPlot::plot_model(RM_values.model, title = "RM_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date)")
sjPlot:: tab_model(RM_values.model, title = "RM_values ~ genotype + (1|animal_ID) + (1|animal_ID:expt_date)",
