...
if(country == "SGP"){
  ...
  m5 <-BIFIE.twolevelreg(BIFIEobj = test,
                         ...
                         formula.random = ~1 + Z_MEAN_DISCLIMA + Z_TEACHER_ABSEENTEISM + Z_STUDENT_ABSEENTEISM,
                         wgtlevel1 <- "W_FSTUWT",
                         wgtlevel2="one",
                         maxiter=1000, se = TRUE)  
  ...
  m6 <-BIFIE.twolevelreg(BIFIEobj = test,
                         ...
                         formula.random = ~1 + Z_AUTONOMY + Z_LEADERSHIP + Z_ACCOUNTABILITY,
                         wgtlevel1 <- "W_FSTUWT",
                         wgtlevel2="one",
                         maxiter=1000, se = TRUE)  
  
  print("calculate model 7")
  m7 <-BIFIE.twolevelreg(BIFIEobj = test,
                         ...
                         formula.fixed = ~1 + Z_ESCS * Z_MEAN_ESCS + 
                           ...
                           Z_DISCLIMA ,
                         formula.random = ~1 + Z_MEAN_ESCS + Z_MEAN_MIG + Z_MEAN_DISCLIMA,
                         wgtlevel1 <- "W_FSTUWT",
                         wgtlevel2="one",
                         maxiter=1000, se = TRUE)
  
  print("calculate model 8")
  ...
  m9 <-BIFIE.twolevelreg(BIFIEobj = test,
                         ...
                         formula.fixed = ~1 + Z_ESCS * Z_MEAN_ESCS + Z_MEAN_MIG +
                           ...
                           Z_AUTONOMY + Z_LEADERSHIP + Z_ACCOUNTABILITY,
                         formula.random = ~1 + Z_MEAN_MIG + Z_MEAN_DISCLIMA + 
  ...
  if(share_migrants < 1){
    ...
    m5 <-BIFIE.twolevelreg(BIFIEobj = test,
                           ...
                           formula.fixed = ~1 + Z_DISCLIMA + 
                             Z_TEACHER_ABSEENTEISM + Z_STUDENT_ABSEENTEISM,
                           formula.random = ~1 + Z_TEACHER_ABSEENTEISM + Z_STUDENT_ABSEENTEISM,
                           wgtlevel1 <- "W_FSTUWT",
                           maxiter=1000, se = TRUE)  
    ...
    m7 <-BIFIE.twolevelreg(BIFIEobj = test,
                           ...
                           #  MIG_2ND  + LANGN +
                             Z_DISCLIMA ,
                           formula.random = ~1 + Z_MEAN_ESCS + Z_MEAN_DISCLIMA,
                           wgtlevel1 <- "W_FSTUWT",
                           maxiter=1000, se = TRUE)
