...
pred.pr.1
pred.se.1
# Stata Pred. Pr. change: coef=.182; se=.033

# Line 13 in Stata file:
lincom.2 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=1,"winretronatl"=1,"infowinretronatl"=1)) 
...
pred.pr.2
pred.se.2
# Stata Pred. Pr. change: coef=.139; se=.030

# Line 15 in Stata file:
lincom.3 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=1,"winpropck"=1,"infowinpropck"=1)) 
...
pred.pr.3
pred.se.3
# Stata Pred. Pr. change: coef=.089; se=.028

# Line 17 in Stata file:
lincom.4 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=1,"winretropck"=1,"infowinretropck"=1)) 
...
pred.pr.4
pred.se.4
# Stata Pred. Pr. change: coef=.035; se=.028
...
lincom.5 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=.5,"winpronatl"=1,"infowinpronatl"=.5)) 
...
pred.pr.5
pred.se.5
# Stata Pred. Pr. change: coef=.127; se=.022

# Line 24 in Stata file:
lincom.6 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=.5,"winretronatl"=1,"infowinretronatl"=.5)) 
...
pred.pr.6
pred.se.6
# Stata Pred. Pr. change: coef=.129; se=.015

# Line 26 in Stata file:
lincom.7 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=.5,"winpropck"=1,"infowinpropck"=.5)) 
...
pred.pr.7
pred.se.7 
# Stata Pred. Pr. change: coef=.082; se=.014

# Line 28 in Stata file:
lincom.8 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=.5,"winretropck"=1,"infowinretropck"=.5)) 
...
pred.pr.8
pred.se.8 
# Stata Pred. Pr. change: coef=.039; se=.012
...
lincom.9 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=0,"winpronatl"=1,"infowinpronatl"=0)) 
...
pred.pr.9
pred.se.9 
# Stata Pred. Pr. change: coef=.067; se=.020

# Line 35 in Stata file:
lincom.10 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=0,"winretronatl"=1,"infowinretronatl"=0)) 
...
pred.pr.10
pred.se.10
# Stata Pred. Pr. change: coef=.120; se=.022

# Line 37 in Stata file:
lincom.11 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=0,"winpropck"=1,"infowinpropck"=0)) 
...
pred.pr.11
pred.se.11
# Stata Pred. Pr. change: coef=.075; se=.009

# Line 39 in Stata file:
lincom.12 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=0,"winretropck"=1,"infowinretropck"=0)) 
...
pred.pr.12
pred.se.12
# Stata Pred. Pr. change: coef=.043; se=.015
...
lincom.13 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=-.5,"winpronatl"=1,"infowinpronatl"=-.5)) 
...
pred.pr.13
pred.se.13
# Stata Pred. Pr. change: coef=.006; se=.031

# Line 47 in Stata file:
lincom.14 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=-.5,"winretronatl"=1,"infowinretronatl"=-.5)) 
...
pred.pr.14
pred.se.14
# Stata Pred. Pr. change: coef=.110; se=.042

# Line 49 in Stata file:
lincom.15 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=-.5,"winpropck"=1,"infowinpropck"=-.5)) 
...
pred.pr.15
pred.se.15
# Pred. Pr. change: coef=.068; se=.021

# Line 51 in Stata file:
lincom.16 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=-.5,"winretropck"=1,"infowinretropck"=-.5)) 
...
pred.pr.16
pred.se.16
# Pred. Pr. change: coef=.047; se=.032
...
lincom.17 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=-1,"winpronatl"=1,"infowinpronatl"=-1)) 
...
pred.pr.17
pred.se.17
# Pred. Pr. change: coef=-.056; se=.045

# Line 58 in Stata file:
lincom.18 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=-1,"winretronatl"=1,"infowinretronatl"=-1)) 
...
pred.pr.18
pred.se.18
# Pred. Pr. change: coef=.100; se=.064

# Line 60 in Stata file:
lincom.19 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=-1,"winpropck"=1,"infowinpropck"=-1)) 
...
pred.pr.19
pred.se.19
# Pred. Pr. change: coef=.060; se=.036

# Line 62 in Stata file:
lincom.20 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=-1,"winretropck"=1,"infowinretropck"=-1)) 
...
pred.pr.20
pred.se.20
# Pred. Pr. change: coef=.051; se=.051
...
lincom.21 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=1,"winpronatl"=0,"infowinpronatl"=0)) 
...
pred.pr.21
pred.se.21
# Stata Pred. Pr. change: coef=.099; se=.045

# Line 70 in Stata file:
lincom.22 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=1,"winretronatl"=0,"infowinretronatl"=0)) 
...
pred.pr.22
pred.se.22
# Stata Pred. Pr. change: coef=.139; se=.029

# Line 72 in Stata file:
lincom.23 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=1,"winpropck"=0,"infowinpropck"=0)) 
...
pred.pr.23
pred.se.23
# Stata Pred. Pr. change: coef=.108; se=.044

# Line 74 in Stata file:
lincom.24 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=1,"winretropck"=0,"infowinretropck"=0)) 
...
pred.pr.24
pred.se.24
# Stata Pred. Pr. change: coef=.020; se=.030
...
lincom.25 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=.5,"winpronatl"=0,"infowinpronatl"=0)) 
...
pred.pr.25
pred.se.25
# Stata Pred. Pr. change: coef=.072; se=.026

# Line 81 in Stata file:
lincom.26 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=.5,"winretronatl"=0,"infowinretronatl"=0)) 
...
pred.pr.26
pred.se.26
# Stata Pred. Pr. change: coef=.126; se=.016

# Line 83 in Stata file:
lincom.27 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=.5,"winpropck"=0,"infowinpropck"=0)) 
...
pred.pr.27
pred.se.27
# Stata Pred. Pr. change: coef=.058; se=.030

# Line 85 in Stata file:
lincom.28 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=.5,"winretropck"=0,"infowinretropck"=0)) 
...
pred.pr.28
pred.se.28
# Stata Pred. Pr. change: coef=.030; se=.018
...
lincom.29 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=0,"winpronatl"=0,"infowinpronatl"=0)) 
...
pred.pr.29
pred.se.29
# Stata Pred. Pr. change: coef=.044; se=.013

# Line 92 in Stata file:
lincom.30 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=0,"winretronatl"=0,"infowinretronatl"=0)) 
...
pred.pr.30
pred.se.30
# Stata Pred. Pr. change: coef=.113; se=.022

# Line 94 in Stata file:
lincom.31 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=0,"winpropck"=0,"infowinpropck"=0)) 
...
pred.pr.31
pred.se.31
# Stata Pred. Pr. change: coef=.007; se=.033

# Line 96 in Stata file:
lincom.32 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=0,"winretropck"=0,"infowinretropck"=0)) 
...
pred.pr.32
pred.se.32
# Stata Pred. Pr. change: coef=.041; se=.022
...
lincom.33 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=-.5,"winpronatl"=0,"infowinpronatl"=0)) 
...
pred.pr.33
pred.se.33
# Stata Pred. Pr. change: coef=.016; se=.021

# Line 103 in Stata file:
lincom.34 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=-.5,"winretronatl"=0,"infowinretronatl"=0)) 
...
pred.pr.34
pred.se.34
# Stata Pred. Pr. change: coef=.100; se=.039

# Line 105 in Stata file:
lincom.35 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=-.5,"winpropck"=0,"infowinpropck"=0)) 
...
pred.pr.35
pred.se.35
# Stata Pred. Pr. change: coef=-.045; se=.048

# Line 107 in Stata file:
lincom.36 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=-.5,"winretropck"=0,"infowinretropck"=0)) 
...
pred.pr.36
pred.se.36
# Stata Pred. Pr. change: coef=.051; se=.035
...
lincom.37 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=-1,"winpronatl"=0,"infowinpronatl"=0)) 
...
pred.pr.37
pred.se.37
# Stata Pred. Pr. change: coef=-.012; se=.040

# Line 114 in Stata file:
lincom.38 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=-1,"winretronatl"=0,"infowinretronatl"=0)) 
...
pred.pr.38
pred.se.38
# Stata Pred. Pr. change: coef=.087; se=.060

# Line 116 in Stata file:
lincom.39 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=-1,"winpropck"=0,"infowinpropck"=0)) 
...
pred.pr.39
pred.se.39
# Stata Pred. Pr. change: coef=-.095; se=.064

# Line 118 in Stata file:
lincom.40 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=-1,"winretropck"=0,"infowinretropck"=0)) 
...
pred.pr.40
pred.se.40
# Stata Pred. Pr. change: coef=.061; se=.052
...
lincom.41 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=1,"winpronatl"=-1,"infowinpronatl"=-1)) 
...
pred.pr.41
pred.se.41
# Stata Pred. Pr. change: coef=.010; se=.073

# Line 125 in Stata file:
lincom.42 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=1,"winretronatl"=-1,"infowinretronatl"=-1)) 
...
pred.pr.42
pred.se.42
# Stata Pred. Pr. change: coef=.139; se=.039

# Line 127 in Stata file:
lincom.43 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=1,"winpropck"=-1,"infowinpropck"=-1)) 
...
pred.pr.43
pred.se.43   
# Stata Pred. Pr. change: coef=.127; se=.069

# Line 129 in Stata file:
lincom.44 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=1,"winretropck"=-1,"infowinretropck"=-1)) 
...
pred.pr.44
pred.se.44
# Stata Pred. Pr. change: coef=.004; se=.041
...
lincom.45 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=.5,"winpronatl"=-1,"infowinpronatl"=-.5)) 
...
pred.pr.45
pred.se.45
# Stata Pred. Pr. change: coef=.016; se=.047

# Line 136 in Stata file:
lincom.46 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=.5,"winretronatl"=-1,"infowinretronatl"=-.5)) 
...
pred.pr.46
pred.se.46
# Stata Pred. Pr. change: coef=.123; se=.026

# Line 138 in Stata file:
lincom.47 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=.5,"winpropck"=-1,"infowinpropck"=-.5)) 
...
pred.pr.47
pred.se.47
# Stata Pred. Pr. change: coef=.034; se=.058

# Line 140 in Stata file:
lincom.48 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=.5,"winretropck"=-1,"infowinretropck"=-.5)) 
...
pred.pr.48
pred.se.48
# Stata Pred. Pr. change: coef=.021; se=.029
...
lincom.49 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=0,"winpronatl"=-1,"infowinpronatl"=0)) 
...
pred.pr.49
pred.se.49
# Stata Pred. Pr. change: coef=.021; se=.024

# Line 147 in Stata file:
lincom.50 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=0,"winretronatl"=-1,"infowinretronatl"=0)) 
...
pred.pr.50
pred.se.50
# Stata Pred. Pr. change: coef=.106; se=.035

# Line 149 in Stata file:
lincom.51 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=0,"winpropck"=-1,"infowinpropck"=0)) 
...
pred.pr.51
pred.se.51
# Stata Pred. Pr. change: coef=-.061; se=.060

# Line 151 in Stata file:
lincom.52 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=0,"winretropck"=-1,"infowinretropck"=0)) 
...
pred.pr.52
pred.se.52
# Stata Pred. Pr. change: coef=.038; se=.032
...
lincom.53 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=-.5,"winpronatl"=-1,"infowinpronatl"=.5)) 
...
pred.pr.53
pred.se.53
# Stata Pred. Pr. change: coef=.027; se=.027

# Line 158 in Stata file:
lincom.54 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=-.5,"winretronatl"=-1,"infowinretronatl"=.5)) 
...
pred.pr.54
pred.se.54
# Stata Pred. Pr. change: coef=.090; se=.058

# Line 160 in Stata file:
lincom.55 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=-.5,"winpropck"=-1,"infowinpropck"=.5)) 
...
pred.pr.55
pred.se.55
# Stata Pred. Pr. change: coef=-.153; se=.067

# Line 162 in Stata file:
lincom.56 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=-.5,"winretropck"=-1,"infowinretropck"=.5)) 
...
pred.pr.56
pred.se.56
# Stata Pred. Pr. change: coef=.055; se=.048
...
lincom.57 <- svycontrast(logit.mod.1,c("ProspNatl"=1, "infopronatl"=-1,"winpronatl"=-1,"infowinpronatl"=1)) 
...
pred.pr.57
pred.se.57
# Stata Pred. Pr. change: coef=.033; se=.05

# Line 169 in Stata file:
lincom.58 <- svycontrast(logit.mod.1,c("RetroNatl"=1, "inforetronatl"=-1,"winretronatl"=-1,"infowinretronatl"=1)) 
...
pred.pr.58
pred.se.58
# Stata Pred. Pr. change: coef=.073; se=.083

# Line 171 in Stata file:
lincom.59 <- svycontrast(logit.mod.1,c("ProspPocket"=1, "infopropck"=-1,"winpropck"=-1,"infowinpropck"=1)) 
...
pred.pr.59
pred.se.59
# Stata Pred. Pr. change: coef=-.234; se=.069

# Line 173 in Stata file:
lincom.60 <- svycontrast(logit.mod.1,c("RetroPocket"=1, "inforetropck"=-1,"winretropck"=-1,"infowinretropck"=1)) 
...
pred.pr.60
pred.se.60
# Stata Pred. Pr. change: coef=.072; se=.069
...
################################################# Write to .csv ############################################################
write.csv(matrix, "/Users/deanlacy/Dropbox/MLEshared/MLE/economicvoting/matrix.csv", row.names=FALSE, na="")


################################################# Create Figure 2 ############################################################
rm(list=ls())
pr3way08<-read.csv("/Users/deanlacy/Dropbox/MLEshared/MLE/economicvoting/matrix.csv")
attach(pr3way08)
pdf("/Users/deanlacy/Dropbox/MLEshared/MLE/economicvoting/figure2new.pdf",width=9,height=8)
