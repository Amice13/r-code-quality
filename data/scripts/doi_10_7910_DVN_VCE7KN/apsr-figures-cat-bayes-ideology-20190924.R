...
# Troops model
coef.1.catbayes <- `m1.cat.bayes.ideology` %>% 
...
# Government model
coef.2.catbayes <- `m2.cat.bayes.ideology` %>% 
  gather_draws(b_mupos_contact_persDontknowDDeclinetoanswer,
               b_mupos_contact_persYes,
               b_mupos_contact_nonpersDontknowDDeclinetoanswer,
               b_mupos_contact_nonpersYes,
...
# People model
coef.3.catbayes <- `m1.cat.bayes.ideology` %>% 
  gather_draws(b_mupos_contact_persDontknowDDeclinetoanswer,
               b_mupos_contact_persYes,
               b_mupos_contact_nonpersDontknowDDeclinetoanswer,
               b_mupos_contact_nonpersYes,
...
ggsave(here("Figures", "apsr-figure-coefplot-cat-bayes-ideology-20190924.pdf"))



# Intercept values
# US Troops
intercept.catbayes.1 <- `m1.cat.bayes.ideology` %>% 
...
# US Government
intercept.catbayes.2 <- `m2.cat.bayes.ideology` %>% 
  spread_draws(b_mupos_Intercept,
               b_muneg_Intercept,
               b_mudk_Intercept,
               r_country__mupos[country],
...
# US People
intercept.catbayes.3 <- `m3.cat.bayes.ideology` %>% 
  spread_draws(b_mupos_Intercept,
               b_muneg_Intercept,
               b_mudk_Intercept,
               r_country__mupos[country],
...
ggsave(here("Figures", "apsr-figure-intercepts-cat-bayes-ideology-20190924.pdf"), width = 11, height = 7.5, units = "in")
