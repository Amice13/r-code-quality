...
Data <- read.table ('AU_cleaned_pairs_Catholic.csv', header=T, sep=',', na.strings=".")
...
savenames <- rbind("AU Catholic 1var_nonresid combinedwpsocial.RData",
                  "AU Catholic 1var_nonresid combinedrel.RData",
                  "AU Catholic 1var_nonresid combinedb5op.RData")
