#*****************************************************************************	
# ---------------- GSC models without MENA countries ----------
#*****************************************************************************
...
data.earlystrongoilall <- subset(data, weak_cs_treat==0 & late_cs_treat ==0 & treated_centre_1900p_tight_no!=1 & region2num!=6)
data.earlystrongoilallsep <- subset(data, weak_sep_treat==0 & late_sep_treat==0 &  treated_split_1900p_tight_no!=1 & region2num!=6)
data.nonoilall <- subset(data, treated_centre_1900p!=1 & region2num!=6)
data.nonoilallsep <- subset(data, treated_split_1900p!=1 & region2num!=6)
