#*****************************************************************************	
# ---------------- Section: Robustness Test 1 – Two-way FEs ----
#*****************************************************************************
...
showtext_auto()
pdf("priad_ipo_oc_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_c_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_os_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_s_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()


setwd("~/secenrol/two-way FE")
...
showtext_auto()
pdf("secenrol_combinedplus_oc_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("secenrol_combinedplus_c_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("secenrol_combinedplus_os_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("secenrol_combinedplus_s_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()



setwd("~/edu_equ/two-way FE")
...
showtext_auto()
pdf("v2peedueq_osp_oc_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_c_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_os_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_s_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()


setwd("~/health_equ/two-way FE")
...
showtext_auto()
pdf("v2pehealth_osp_oc_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_c_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_os_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_s_r1tw.pdf",width=16,height=12)
print(p6)
dev.off()
