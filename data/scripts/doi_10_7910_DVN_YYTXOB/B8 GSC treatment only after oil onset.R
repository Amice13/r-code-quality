#*****************************************************************************	
# ---------------- Tight treatment variable (only after oil onset) ----------------
#*****************************************************************************
...
out <- gsynth(priad_ipo ~ treated_centre_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilall, index = c("cowcode","year"), 
...
showtext_auto()
pdf("priad_ipo_oc_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_c_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
out <- gsynth(priad_ipo~ treated_split_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilallsep, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 10, 
              parallel = TRUE, estimator = "ife", EM = TRUE)
...
showtext_auto()
pdf("priad_ipo_os_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_s_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()


setwd("~/secenrol/tight treatment")
...
out <- gsynth(secenrol_combinedplus ~ treated_centre_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilall, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 10, 
              parallel = TRUE, estimator = "ife", EM = TRUE)
...
showtext_auto()
pdf("secenrol_combinedplus_oc_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("secenrol_combinedplus_c_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
out <- gsynth(secenrol_combinedplus~ treated_split_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilallsep, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 10, 
              parallel = TRUE, estimator = "ife", EM = TRUE)
...
showtext_auto()
pdf("secenrol_combinedplus_os_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("secenrol_combinedplus_s_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()


setwd("~/edu_equ/tight treatment")
...
out <- gsynth(v2peedueq_osp ~ treated_centre_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilall, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 10, 
              parallel = TRUE, estimator = "ife", EM = TRUE)
...
showtext_auto()
pdf("v2peedueq_osp_oc_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_c_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
out <- gsynth(v2peedueq_osp~ treated_split_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilallsep, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 10, 
              parallel = TRUE, estimator = "ife", EM = TRUE)
...
showtext_auto()
pdf("v2peedueq_osp_os_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_s_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()



setwd("~/health_equ/tight treatment")
...
out <- gsynth(v2pehealth_osp ~ treated_centre_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilall, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 10, 
              parallel = TRUE, estimator = "ife", EM = TRUE)
...
showtext_auto()
pdf("v2pehealth_osp_oc_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_c_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
out <- gsynth(v2pehealth_osp~ treated_split_1900p_tight + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilallsep, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 10, 
              parallel = TRUE, estimator = "ife", EM = TRUE)
...
showtext_auto()
pdf("v2pehealth_osp_os_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_s_r4ti.pdf",width=16,height=12)
print(p6)
dev.off()
