#*****************************************************************************	
# ---------------- GSC models with shorter pre-period -------------
#*****************************************************************************
...
out <- gsynth(priad_ipo ~ treated_centre_1900p + ln_oilpc + popdensity_UNDP + v2x_polyarchy + civilwar_combined + war_combined + leftistideo + v2x_clphy + lngdppc_vdemplus_ipo + urbanisation_UNDP + hiv_WDI, data = data.earlystrongoilall, index = c("cowcode","year"), 
              force = unit, CV = TRUE, r = c(0, 5), se = TRUE, inference = "parametric", nboots = 1000, na.rm = TRUE, min.T0 = 7, 
...
showtext_auto()
pdf("priad_ipo_oc_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_c_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_os_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("priad_ipo_s_r37y.pdf",width=16,height=12)
print(p6)
dev.off()


setwd("~/secenrol/shorter preperiod")
...
showtext_auto()
pdf("secenrol_combinedplus_oc_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
p6 <- ggplot(data=data.plot2 , aes(x=time, y=ATT2, group=1)) +
  ...
  theme(axis.text=element_text(size=rel(3.1)),
        ...
        axis.line = element_line(color ="black"),
        axis.title.y = element_text(margin = margin(t = 0, r = 8, b = 0, l = 0)),
        axis.title.x = element_text(margin = margin(t = 8, r = 0, b = 0, l = 0)),r
        axis.text.x = element_text(margin = margin(t = 8, r = 0, b = 0, l = 0)),
        axis.text.y = element_text(margin = margin(t = 0, r = 8, b = 0, l = 0)),
        text=element_text(family="lat"))

showtext_auto()
pdf("secenrol_combinedplus_c_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("secenrol_combinedplus_os_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("secenrol_combinedplus_s_r37y.pdf",width=16,height=12)
print(p6)
dev.off()



setwd("~/edu_equ/shorter preperiod")
...
showtext_auto()
pdf("v2peedueq_osp_oc_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_c_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_os_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2peedueq_osp_s_r37y.pdf",width=16,height=12)
print(p6)
dev.off()



setwd("~/health_equ/shorter preperiod")
...
showtext_auto()
pdf("v2pehealth_osp_oc_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_c_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_os_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
...
showtext_auto()
pdf("v2pehealth_osp_s_r37y.pdf",width=16,height=12)
print(p6)
dev.off()
