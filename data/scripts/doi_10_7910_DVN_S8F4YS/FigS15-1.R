##  THIS SCRIPT OUTPUTS FIGS15, WHICH PLOTS THE EFFECTS ON SUBSETS DEFINED BY LIVING
...
## SAVE PLOT
ggsave(file = "03-output/01-plots/FigS15.jpeg", plot = p, width = 9, height = 5, units = 'in', dpi=600)
