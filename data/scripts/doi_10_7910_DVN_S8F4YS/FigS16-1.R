##  THIS SCRIPT OUTPUTS FIGS16, WHICH PLOTS THE EFFECTS ON SUBSETS DEFINED BY LIVING
## NEXT TO A NEIGHBOR WITH MALE CHILDREN OF SIMILAR AGES TO THE SUBJECT IN 1940.
...
### INDICATOR FOR NEIGHBOR WITH HS DEGREE
...
#######################################
df[,playmate:=as.numeric(agedist<=5 & malechild ==1 & malechild_opposite1_dist_1 == 0)]
#
#########################
#### ESTIMATE MODELS ####
#########################
...
#######################################
df[,playmate:=as.numeric(agedist<=7 & malechild ==1 & malechild_opposite1_dist_1 == 0)]
#
#########################
#### ESTIMATE MODELS ####
#########################
...
#######################################
df[,playmate:=as.numeric(agedist<=3 & malechild ==1 & malechild_opposite1_dist_1 == 0)]
#
#########################
#### ESTIMATE MODELS ####
#########################
...
#### First Category: Age Dist =< 5 ####
#######################################
df[,playmate:=as.numeric(agedist<=5 & malechild ==1 & malechild_opposite_dist_1 == 0)]
################
#### ESTIMATE MODELS ####
#########################
...
#### Second Category: Age Dist =< 7 ####
#######################################
df[,playmate:=as.numeric(agedist<=7 & malechild ==1 & malechild_opposite_dist_1 == 0)]
#########################
#### ESTIMATE MODELS ####
#########################
...
#### Third Category: Age Dist =< 3 ####
#######################################
df[,playmate:=as.numeric(agedist<=3 & malechild ==1 & malechild_opposite_dist_1 == 0)]
#########################
#### ESTIMATE MODELS ####
#########################
...
## SAVE PLOT
ggsave(file = "03-output/01-plots/FigS16.jpeg", plot = p, width = 9, height = 5, units = 'in', dpi=600)
