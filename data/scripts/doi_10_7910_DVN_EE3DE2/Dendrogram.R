...
sel_t <-which(tt[,k]>0.87) #see how to select significant variables in the paper
...
sel_t <-which(tt[,k]>0.87)

symm_M0<-symm_M[sel_t[-1],sel_t[-1]] #### removing intercept, a matrix of the neighbor structure of selected variables
