...
saveRDS(model.ls, file = file.path(tem_res.path, "rescheck_contronly_model.ls.rds"))
# model.ls <- readRDS(file.path(tem_res.path, "rescheck_contronly_model.ls.rds"))
...
saveRDS(se.ls, file = file.path(tem_res.path, "rescheck_contronly_se.ls.rds"))
