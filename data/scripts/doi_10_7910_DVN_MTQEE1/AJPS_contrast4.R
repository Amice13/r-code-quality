...
pewdata <- read.dta("entropycontrast5.dta")
attach(pewdata)
...
control<-read.dta("entropycontrol_contrast5.dta")
...
#write.dta(control.data, "/Users/bsjjones/Dropbox/AJPS R&R/Analysis Files/control_115GNC225G.dta")

#write.dta(control.data, "/Users/bradfordjones/Dropbox/AJPS R&R/Analysis Files/control_115GNC225G.dta")
write.dta(control.data, "control_115GNC225G.dta")
