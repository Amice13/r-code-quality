...
#is merged in Stata with the treated cases.  It is in Stata that the 
#proportional odds models are estimated.

#First Generation Spanish Dominant
...
pewdata <- read.dta("entropycontrast1.dta")
attach(pewdata)
...
control<-read.dta("entropycontrol_contrast1.dta")
...
#write.dta(control.data, "/Users/bradfordjones/Dropbox/AJPS R&R/Analysis Files/control_1GSD.dta")
write.dta(control.data, "control_1GSD.dta")
