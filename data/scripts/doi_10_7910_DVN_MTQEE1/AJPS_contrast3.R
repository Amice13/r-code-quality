...
pewdata <- read.dta("entropycontrast3.dta")
attach(pewdata)
...
control<-read.dta("entropycontrol_contrast3.dta")
...
#write.dta(control.data, "/Users/bsjjones/Dropbox/AJPS R&R/Analysis Files/control_115GBI.dta")

#write.dta(control.data, "/Users/bradfordjones/Dropbox/AJPS R&R/Analysis Files/control_115GBI.dta")
write.dta(control.data, "control_115GBI.dta")
