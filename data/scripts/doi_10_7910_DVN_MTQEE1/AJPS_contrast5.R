...
pewdata <- read.dta("entropycontrast7.dta")
attach(pewdata)
...
#Balancing Procedure  
eb.out<- ebalance(Treatment=contrast, X=X)
...
control<-read.dta("entropycontrol_contrast7.dta")
...
#write.dta(control.data, "/Users/bsjjones/Dropbox/AJPS R&R/Analysis Files/control_115GC225G.dta")

#write.dta(control.data, "/Users/bradfordjones/Dropbox/AJPS R&R/Analysis Files/control_115GC225G.dta")
write.dta(control.data, "control_115GC225G.dta")
