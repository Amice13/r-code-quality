...
pewdata <- read.dta("entropycontrast8.dta")
attach(pewdata)
...
control<-read.dta("entropycontrol_contrast8.dta")
...
#write.dta(control.data, "/Users/bsjjones/Dropbox/AJPS R&R/Analysis Files/control_225G3G.dta")

#write.dta(control.data, "/Users/bradfordjones/Dropbox/AJPS R&R/Analysis Files/control_225G3G.dta")
write.dta(control.data, "control_225G3G.dta")
