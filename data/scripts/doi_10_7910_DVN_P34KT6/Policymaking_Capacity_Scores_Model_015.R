...
#### Model 015
items015 <- c("POLICYEMPLOYEE_DC_GENRESEARCHINCLUDED_RAWNUM_LOG",
              ...
              "POLICYEMPLOYEE_DC_GENRESEARCHINCLUDED_COLLEGE_PROP")
name015 <- "policymaking_scores_m015"
Capacity_IRT(items015,name015)
rm(items015,name015)