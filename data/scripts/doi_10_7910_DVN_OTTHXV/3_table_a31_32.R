...
test_mod1 <- lm(V_61_A == 4 ~ treatment*other_people, data = models_data)
test_mod2 <- lm(V_61_B == 4 ~ treatment*other_people, data = models_data)
test_mod3 <- lm(V_61_C== 4 ~ treatment*other_people, data = models_data)
test_mod4 <- lm(V_61_D== 4 ~ treatment*other_people, data = models_data)
test_mod5 <- lm(V_61_E== 4 ~ treatment*other_people, data = models_data)
test_mod6 <- lm(V_62_A== 4 ~ treatment*other_people, data = models_data)
test_mod7 <- lm(V_62_B== 4 ~ treatment*other_people, data = models_data)
...
table = stargazer(table, type = 'latex', 
                  title = "The Effect of Intervention on Policy Support, by Observer Present",
                  label = 'tab:table_policy_observer',
                  model.names = F,
                  model.numbers = T,
                  digits = 3,
                  ...
                  covariate.labels = c("Treatment ($T$)", "Observer ($O$)", "$T$ X $O$"),
...
table[-c(10, 11, 12, 18, 21, 24, 27, 32)] %>%
  ...
  write_latex(., note_text, './_4_outputs/tables/table_a32.tex', .8)





#### doing observer analysis for first order beliefs


#here are the base models
test_mod1 <- lm(V_12_A==4 ~ treatment*other_people, data = models_data)
test_mod2 <- lm(V_12_B==4 ~ treatment*other_people, data = models_data)
test_mod3 <- lm(V_12_C==4 ~ treatment*other_people, data = models_data)
test_mod4 <- lm(V_12_D==4 ~ treatment*other_people, data = models_data)
test_mod5 <- lm(V_12_E==4 ~ treatment*other_people, data = models_data)
test_mod6 <- lm(V_12_F==4 ~ treatment*other_people, data = models_data)
test_mod7 <- lm(V_12_G==4 ~ treatment*other_people, data = models_data)
test_mod8 <- lm(avg_index_v12 ~ treatment*other_people, data = models_data)
...
#creating the stargazer table
table = stargazer(table, type = 'latex', 
                  title = "The Effect of Intervention on Politicians' First-Order Views, by Observer Present",
                  label = 'tab:table_1_observer',
                  model.names = F,
                  model.numbers = T,
                  digits = 3,
...
table[-c(10, 11, 12, 18, 21, 24, 27, 32)] %>%
  ...
  write_latex(., note_text, './_4_outputs/tables/table_a31.tex', .8)
