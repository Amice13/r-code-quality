...
test_mod1 <- lm(V_13_A== 4 ~ treatment*education, data = models_data)
test_mod2 <- lm(V_13_B== 4 ~ treatment*education, data = models_data)
test_mod3 <- lm(V_13_C== 4 ~ treatment*education, data = models_data)
test_mod4 <- lm(V_13_D== 4 ~ treatment*education, data = models_data)
test_mod5 <- lm(V_13_E== 4 ~ treatment*education, data = models_data)
test_mod6 <- lm(V_13_F== 4 ~ treatment*education, data = models_data)
test_mod7 <- lm(V_13_G== 4 ~ treatment*education, data = models_data)
test_mod8 <- lm(avg_index_v13 ~ treatment*education, data = models_data)
...
table = stargazer(table, type = 'latex', 
                  title = "The Effect of Informational Treatment by Education (Second-order Beliefs)",
...
table[-c(10, 11, 12, 18, 21, 24, 27, 32)] %>%
  ...
  write_latex(., note_text, './_4_outputs/tables/table_a20.tex', .8)
