...
# Custom note text
note_text <- "Coefficients from OLS regression. Robust and unclustered standard errors. Outcomes capturing whether respondents thought the following issues were very important: (1) health, (2) education, (3) civil rights, (4) economy, (5) minority rights, (6) climate change, (7) pollution, (8) environment (index)."

# Generate the stargazer table
table_latex = stargazer(table, type = 'latex',
                  title = "Effect of intervention on politicians' issue prioritization",
                  label = 'tab:table_1',
                  model.names = FALSE,
                  model.numbers = TRUE,
                  digits = 3,
...
table_latex[-c(10, 11, 12, 18, 21, 26)] %>%
  ...
  write_latex(., note_text, './_4_outputs/tables/table_1.tex', .8)
...
write_html(table_html, note_text, './_4_outputs/tables_doc/table_1.html')
...
write_csv(results_df, "./_4_outputs/supplementary/table_1.csv")
