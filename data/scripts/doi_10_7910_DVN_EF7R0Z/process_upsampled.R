# takes the Hansen 2018 data, upsamples to 0.5dd, converts to panel forest change with country labels
# Requires: 
...
get_neighbors<-function(raster){
    ...
    raster<-aggregate(raster,fact=10,fun=mean)
...
df <- df %>% right_join(GEZ_dictionary)
...
save(master,file="../data/output/forest_upsampled_10.Rdata")
