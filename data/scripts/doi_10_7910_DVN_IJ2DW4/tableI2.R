...
### Table I.2: Ethnic minority victory effects on mass attitudes towards immigrants (3 outcomes)
outcomes <- c('immigrants_economy', 'j05', 'attitudes_migrants')
y_labels <- c('immigration good for economy', 'not too many immigrants', 'inclusionary attitudes: general index')
...
for (i in outcomes) {
  ...
  # c('ethnicity_minority', 'economically_unemployed', 'incumbent')
...
print(xtable(tablei2,
      ...
      add.to.row = comment,
      timestamp = NULL,
      file='./output/tables/tableI2.tex')
