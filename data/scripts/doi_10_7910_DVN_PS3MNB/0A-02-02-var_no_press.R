...
# simulation of 60 days ahead showing the results without the press releases
...
variables <- c("Media_SMD", "Media_TW", "Gov_TW", "Org_TW", "Party_TW", "Politician_TW")
...
variables_single <- c("Media_SMD", "Media_TW", "Gov_TW", "Org_TW", "Party_TW", "Politician_TW")
variables_all <- c("Media_SMD", "Media_TW", "Gov_TW", "Org_TW", "Party_TW", "Politician_TW", "selectsclass")
##########################################################################################
# 4) Model Maker
##########################################################################################
##########################################################################################
...
# - save models for later useage
saveRDS(var_model_merged, "../var/var_model_all_small_no_pr.RDS")
saveRDS(var_irfs_cum_merged, "../var/var_irfs_main_all_small_no_pr.RDS")
##########################################################################################
# 5) Calculating ONE-TIME and PERMANENT 10-POINT EFFECTS
##########################################################################################
...
saveRDS(all_irf_data_wide_all,
        "../var/onetime-structural-shock-irfs-results_all_small_no_pr.RDS")
##########################################################################################
