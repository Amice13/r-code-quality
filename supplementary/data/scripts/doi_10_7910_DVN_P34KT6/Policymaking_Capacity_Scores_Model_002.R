...
data <- read_csv("fedscope_compiled_backup04212022.csv") %>%
...
#### Model 002
items002 <- c("POLICYEMPLOYEE_GENRESEARCHINCLUDED_RAWNUM_LOG",
              "POLICYEMPLOYEE_GENRESEARCHINCLUDED_PROP",
              "POLICYEMPLOYEE_GENRESEARCHINCLUDED_SALARY_MEAN",
              "POLICYEMPLOYEE_GENRESEARCHINCLUDED_LOS_MEAN",
              "POLICYEMPLOYEE_GENRESEARCHINCLUDED_POSTCOLLEGE_PROP")
name002 <- "policymaking_scores_m002_primaryspecification"
Capacity_IRT(items002,name002)
rm(items002,name002)