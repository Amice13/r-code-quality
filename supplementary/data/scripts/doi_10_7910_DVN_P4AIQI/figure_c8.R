...
# remove respondent-tasks that took longer than ten seconds

dat = dat[dat$timing>=10,]
...
ggplot(data=mod_cdu_morerestrict_ests, aes(x=voted_for, y=coef)) + 
  ...
  scale_y_continuous(breaks=seq(0, .12, .04))

# save Figure.C8

ggsave("figures/figure_c8.pdf", width=7, height=5)
