#################### Table A8: Non-ethnic Revisionism
...
etable(m.list,tex=T, keep = c("lost","Former", "Lost"),
       order = c("lost","Former", "Lost"),
       dict = var.labs,
       title="Territorial Claims: Non-ethnic Revisionism?",
       label="tab:tc_revisionism",
       style.tex = style.tex(main="base"), 
       file=file.path(tab.path,"table_A8.tex"),replace=T,
