...
callum_pilot = read_csv("victimhood_out/pilot_3/pilot_main_3_CC.csv") %>%
  select(channel_id, running_document, message, victim_cc)

constantine_pilot = read_csv("victimhood_out/pilot_3/pilot_main_3_CB.csv") %>%
...
combined %>% 
  ...
  write_csv("victimhood_out/pilot_3/disagreements.csv")
