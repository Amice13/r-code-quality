...
setwd("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.535/")

tree<-read.newick('~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.535/timetree.nwk')
...
metadata_df <- read.csv("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.535/meta_globe+Ken_subsampleone_B.1.535_wave2.csv")%>%
...
global_tre <-  p%<+% metadata_df+ 
  ...
  scale_y_continuous(limits=c(0,1800), minor_breaks = seq(0 , 1800, 250), breaks = seq(0 , 1800, 250))+
...
pdf("~/Dropbox/COVID-19/SECONDWAVE/revisedcode/Figures/Fig.6/B.1.535/Fig.6G.pdf", width = 3.5, height = 7)
print(global_tre)
dev.off()
