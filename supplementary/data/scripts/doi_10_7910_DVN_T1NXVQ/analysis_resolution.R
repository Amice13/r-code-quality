#############################
# PSPM WITH VARYING NETWORK RESOLUTION
# 
# 
# Part of:
...
saveRDS(model.ls, file = file.path(tem_res.path, "rescheck_model.ls.rds"))
# model.ls <- readRDS(file.path(tem_res.path, "rescheck_model.ls.rds"))
...
saveRDS(se.ls, file = file.path(tem_res.path, "rescheck_se.ls.rds"))
...
saveRDS(model.ls, file = file.path(tem_res.path, "rescheck_model.ls.rds"))
# se.ls <- readRDS(file.path(tem_res.path, "rescheck_se.ls.rds"))
