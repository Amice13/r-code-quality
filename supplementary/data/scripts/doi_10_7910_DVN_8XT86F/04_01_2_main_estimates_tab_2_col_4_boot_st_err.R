...
#
#                             Replication scripts
#        Main Estimates - Table 2 Column 4 Bootstrapped Standard Errors
...
# load data
load("replication_data_second_step_school_fe.rda")
load("main_estimates_school_fe.rda")
...
boot_main_estimates <- boot(object = fit, 
                            hypothesis = "lim", 
                            group = db$id_2, 
...
# print results column 4 table 2
boot_main_estimates