...
CRP_values$drug <- factor(CRP_values$drug, levels = c("saline", "etomidate 7mg/kg"))
...
sjPlot::plot_model(CRP_values.model, title = "CRP_values ~ drug * genotype + (1|animal_ID) + (1|expt_date)")
