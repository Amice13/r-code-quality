...
CAR <- filter(read_excel("../Original Data/2019-2020 Season/ANA.xlsx"), HomeTeam=="CAR")
...
CAR <- filter(read_excel("../Original Data/2020-2021 Season/ANA.xlsx"), HomeTeam=="CAR")
...
CAR <- filter(read_excel("../Original Data/2021-2022 Season/ANA.xlsx"), HomeTeam=="CAR")
...
SEA <- filter(read_excel("../Original Data/2021-2022 Season/PIT.xlsx"), HomeTeam=="PIT")
...
Book_Data <- AllGames %>% 
  gather(key= "book", value="deviation",
         DKDifHome: UnibetDifAway)%>%
  mutate(book=as.factor(book))

ggplot(Book_Data, aes(x = deviation, y= 0)) +
  geom_point() + 
  geom_smooth(method = "lm") +
  facet_wrap(~book)  

ggplot(Book_Data, aes(x = deviation, y = book)) +
  geom_point() + 
  geom_smooth(method = "lm") +
  facet_wrap(~book)  
...
HomeConsensus<- glm(HomeWin~ConsensusLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayConsensus<- glm(AwayWin~ConsensusLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeDK<- glm(HomeWin~DKLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayDK<- glm(AwayWin~DKLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeFanDuel<- glm(HomeWin~FanDuelLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayFanDuel<- glm(AwayWin~FanDuelLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeSugarHousePA<- glm(HomeWin~SugarHousePALogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwaySugarHousePA<- glm(AwayWin~SugarHousePALogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeParx<- glm(HomeWin~ ParxLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayParx<- glm(AwayWin~ ParxLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeSportNJ <- glm(HomeWin~ SportNJLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwaySportNJ <- glm(AwayWin~ SportNJLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeRiversCasinoPA <- glm(HomeWin~RiversCasinoPALogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayRiversCasinoPA <- glm(AwayWin~RiversCasinoPALogOddsAway, data = Odds_Data, family= binomial(link=logit))


HomePointsBet<- glm(HomeWin~ PointsBetLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayPointsBet<- glm(AwayWin~PointsBetLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeBetMGM<- glm(HomeWin~BetMGMLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayBetMGM<- glm(AwayWin~BetMGMLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeUnibet<- glm(HomeWin~UnibetLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayUnibet<- glm(AwayWin~UnibetLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeBarstool<- glm(HomeWin~BarstoolLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayBarstool<- glm(AwayWin~BarstoolLogOddsAway, data = Odds_Data, family= binomial(link=logit))

HomeCaesars<- glm(HomeWin~CaesarsLogOddsHome, data = Odds_Data, family= binomial(link=logit))
AwayCaesars<- glm(AwayWin~CaesarsLogOddsAway, data = Odds_Data, family= binomial(link=logit))





stargazer(HomeConsensus, AwayConsensus, HomeDK, AwayDK, HomeFanDuel, AwayFanDuel, HomeSugarHousePA, AwaySugarHousePA, HomeParx, AwayParx, HomeSportNJ, AwaySportNJ, HomeRiversCasinoPA, AwayRiversCasinoPA, HomePointsBet, AwayPointsBet, HomeBetMGM, AwayBetMGM, HomeUnibet, AwayUnibet, HomeBarstool, AwayBarstool, HomeCaesars, AwayCaesars,
          keep.stat = c("n", "rsq"), type="text")
summary(HomeDK)


stargazer(HomeConsensus, AwayConsensus, HomeDK, AwayDK, HomeFanDuel, AwayFanDuel, HomeSugarHousePA, AwaySugarHousePA, HomeParx, AwayParx, HomeSportNJ, AwaySportNJ, 
          keep.stat = c("n", "rsq"), type="text")



stargazer(HomeRiversCasinoPA, AwayRiversCasinoPA, HomePointsBet, AwayPointsBet, HomeBetMGM, AwayBetMGM, HomeUnibet, AwayUnibet, HomeBarstool, AwayBarstool, HomeCaesars, AwayCaesars,
          keep.stat = c("n", "rsq"), type="text")
...
FanDuelHomewald.model$result$chi2

FanDuelAway_model <- glm(AwayWin~lFanDueloddsAway, data = Odds_Data, family= binomial(link=logit))
FanDuelAwaywald.model <- wald.test(b = coef(FanDuelAway_model), varb = vcov(FanDuelAway_model), Terms = 1:2, H0 = c(0, -1))
FanDuelAwaywald.model$result$chi2
...
SugarHousePAHomewald.model$result$chi2

SugarHousePAAway_model <- glm(AwayWin~lSugarHousePAoddsAway, data = Odds_Data, family= binomial(link=logit))
SugarHousePAAwaywald.model <- wald.test(b = coef(SugarHousePAAway_model), varb = vcov(SugarHousePAAway_model), Terms = 1:2, H0 = c(0, -1))
SugarHousePAAwaywald.model$result$chi2
...
ParxHomewald.model$result$chi2

ParxAway_model <- glm(AwayWin~lParxoddsAway, data = Odds_Data, family= binomial(link=logit))
ParxAwaywald.model <- wald.test(b = coef(ParxAway_model), varb = vcov(ParxAway_model), Terms = 1:2, H0 = c(0, -1))
ParxAwaywald.model$result$chi2
...
SportNJHomewald.model$result$chi2

SportNJAway_model <- glm(AwayWin~lSportNJoddsAway, data = Odds_Data, family= binomial(link=logit))
SportNJAwaywald.model <- wald.test(b = coef(SportNJAway_model), varb = vcov(SportNJAway_model), Terms = 1:2, H0 = c(0, -1))
SportNJAwaywald.model$result$chi2
...
RiversCasinoPAHomewald.model$result$chi2

RiversCasinoPAAway_model <- glm(AwayWin~lRiversCasinoPAoddsAway, data = Odds_Data, family= binomial(link=logit))
RiversCasinoPAAwaywald.model <- wald.test(b = coef(RiversCasinoPAAway_model), varb = vcov(RiversCasinoPAAway_model), Terms = 1:2, H0 = c(0, -1))
RiversCasinoPAAwaywald.model$result$chi2
...
CaesarsHomewald.model$result$chi2

CaesarsAway_model <- glm(AwayWin~lCaesarsoddsAway, data = Odds_Data, family= binomial(link=logit))
CaesarsAwaywald.model <- wald.test(b = coef(CaesarsAway_model), varb = vcov(CaesarsAway_model), Terms = 1:2, H0 = c(0, -1))
CaesarsAwaywald.model$result$chi2
...
PointsBetHomewald.model$result$chi2

PointsBetAway_model <- glm(AwayWin~lPointsBetoddsAway, data = Odds_Data, family= binomial(link=logit))
PointsBetAwaywald.model <- wald.test(b = coef(PointsBetAway_model), varb = vcov(PointsBetAway_model), Terms = 1:2, H0 = c(0, -1))
PointsBetAwaywald.model$result$chi2
...
BetMGMHomewald.model$result$chi2

BetMGMAway_model <- glm(AwayWin~lBetMGModdsAway, data = Odds_Data, family= binomial(link=logit))
BetMGMAwaywald.model <- wald.test(b = coef(BetMGMAway_model), varb = vcov(BetMGMAway_model), Terms = 1:2, H0 = c(0, -1))
BetMGMAwaywald.model$result$chi2
...
UnibetHomewald.model$result$chi2

UnibetAway_model <- glm(AwayWin~lUnibetoddsAway, data = Odds_Data, family= binomial(link=logit))
UnibetAwaywald.model <- wald.test(b = coef(UnibetAway_model), varb = vcov(UnibetAway_model), Terms = 1:2, H0 = c(0, -1))
UnibetAwaywald.model$result$chi2
...
BarstoolHomewald.model$result$chi2

BarstoolAway_model <- glm(AwayWin~lBarstooloddsAway, data = Odds_Data, family= binomial(link=logit))
BarstoolAwaywald.model <- wald.test(b = coef(BarstoolAway_model), varb = vcov(BarstoolAway_model), Terms = 1:2, H0 = c(0, -1))
BarstoolAwaywald.model$result$chi2
...
ConsensusHomewald.model$result$chi2

ConsensusAway_model <- glm(AwayWin~lConsensusoddsAway, data = Odds_Data, family= binomial(link=logit))
ConsensusAwaywald.model <- wald.test(b = coef(ConsensusAway_model), varb = vcov(ConsensusAway_model), Terms = 1:2, H0 = c(0, -1))
ConsensusAwaywald.model$result$chi2
...
stargazer(  Caesars_model21, Caesars_model22,
            keep.stat = c("n", "rsq"), type="text")
...
Caesarswald.model22$result$chi2
...
stargazer( BetMGM_model20, BetMGM_model21, BetMGM_model22,
           keep.stat = c("n", "rsq"), type="text")
...
BetMGMwald.model22$result$chi2
...
stargazer( Unibet_model20,Unibet_model21,Unibet_model22,
           keep.stat = c("n", "rsq"), type="text")
...
Unibetwald.model22$result$chi2
...
knitr::kable(Chart_data1 , caption = "Results")

#knitr::kable(data.frame(col1 = Chart_data1[1], col2 = linebreak(Chart_data1[2]), col3 = linebreak(Chart_data1[3]), col4 = Chart_data1[4]), caption = "Results")
...
DKHomewald.modelYear$result$chi2
...
FanDuelHomewald.modelYear$result$chi2
...
ParxHomewald.modelYear$result$chi2
...
SportNJHomewald.modelYear$result$chi2
...
RiversCasinoPAHomewald.modelYear$result$chi2
...
CaesarsHomewald.modelYear$result$chi2
...
PointsBetHomewald.modelYear$result$chi2
...
BetMGMHomewald.modelYear$result$chi2
...
UnibetHomewald.modelYear$result$chi2
...
ConsensusHomewald.modelYear$result$chi2
...
graph.data <- graph.data %>%
  mutate(efficient = 1/(1 + exp(-1 * (0 + -1 * log(Odds)))),
         Caesars = 1/(1 + exp(-1 * (HomeCaesars$coefficients[1] + HomeCaesars$coefficients[2] * log(Odds))))
  )

graph.data <- graph.data %>%
  mutate(efficient = 1/(1 + exp(-1 * (0 + -1 * log(Odds)))),
         BetMGM = 1/(1 + exp(-1 * (HomeBetMGM$coefficients[1] + HomeBetMGM$coefficients[2] * log(Odds))))
  )

graph.data <- graph.data %>%
  mutate(efficient = 1/(1 + exp(-1 * (0 + -1 * log(Odds)))),
         Unibet = 1/(1 + exp(-1 * (HomeUnibet$coefficients[1] + HomeUnibet$coefficients[2] * log(Odds))))
  )
