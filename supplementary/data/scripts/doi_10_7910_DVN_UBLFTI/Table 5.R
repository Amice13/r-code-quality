...
Att_Attendance_conditional_NT <- att_gt(yname = "Attendance", 
                                        ...
                                        panel = TRUE) 
Attendance_agg_Conditional_NT <- aggte(Att_Attendance_conditional_NT, type = "group")

stargazer(results(Attendance_agg_Conditional_NT),summary=F,type="text", out="Table5.htm")
