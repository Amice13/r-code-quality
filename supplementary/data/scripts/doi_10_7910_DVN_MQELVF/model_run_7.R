...
model.data <- model.frame(un.yes~capdist+nlights_max+nlights_max.l1+nlights_mean+nlights_mean.l1+nlights_calib_mean_orig+nlights_calib_mean.l1_orig+pop_gpw_sum+best.ged.beforeUN+ttime_mean+best.ged+light.1994+No.troops_sp+No.troops.country+No.troops+afterUN.period.spell+duringUN.period.spell+year+gid+country_name+redeploy.period+time.since.last.best.gid+time.since.last.best.country,data=un.data.final[un.data.final$year<=2012 & un.data.final$year>1994,])
