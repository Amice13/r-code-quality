# ====
# Table C5 Replication:
# Extensive margin results with Imports, all goods
# input: extensive_margin_paneldata_Import_all.csv
...
data.plot.panel.used <- read_csv(file = paste0(REPLICATION_DATA_DIR, 
                            "extensive_margin_paneldata_Import_all.csv"))
...
writeLines(tab.appendix, paste0(REPLICATION_FIG_DIR,
                         "TC5_Extensive_results_Imports_allgoods_table.tex"))
...
writeLines(tab.appendix.html, paste0(REPLICATION_FIG_DIR,
                         "TC5_Extensive_results_Imports_allgoods_table.html"))