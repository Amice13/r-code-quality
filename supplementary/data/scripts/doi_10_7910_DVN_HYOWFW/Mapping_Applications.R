...
qdmap <- function(spobj, x, y, frame=NULL, border="black", zlim=0, lang="en", cex.leg=1, palet=c("royalblue","red2","#FFFF99","#7FC97F"), lwd=1, lwd.frame=2, leg.pos="bottomleft", cor.pos= c(-41.71177, -31.07674),y.intersp=0.7, x.intersp=0.4, selqad=1, add=F, ret.col=F, selcat=5){
