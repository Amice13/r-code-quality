# plot.amce function adapted from the cjoint-package 2.0.6 by 
# Soubhik Barari, Elissa Berwick, Jens Hainmueller, Daniel Hopkins, 
# Sean Liu, Anton Strezhnev, Teppei Yamamoto

# Basically, replaces several 'print()' with a new one in line 677, so the call
# returns a ggplot-object which can be reused
