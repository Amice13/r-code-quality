...
tab2.1 <- lfe::felm(as.formula(paste0(mod2.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data[, datafilter]))
#summary(tab2.1)

data2.2 <- data %>% filter(ucdp_0yrs == 1)
tab2.2 <- lfe::felm(as.formula(paste0(mod2.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data2.2[, datafilter]))
#summary(tab2.2)

data2.3 <- data %>% filter(ucdp_1yrs == 1)
tab2.3 <- lfe::felm(as.formula(paste0(mod2.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data2.3[, datafilter]))
#summary(tab2.3)

data2.4 <- data %>% filter(ucdp_2yrs == 1)
tab2.4 <- lfe::felm(as.formula(paste0(mod2.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data2.4[, datafilter]))
#summary(tab2.4)

data2.5 <- data %>% filter(ucdp_3yrs == 1)
tab2.5 <- lfe::felm(as.formula(paste0(mod2.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data2.5[, datafilter]))
#summary(tab2.5)
...
texreg::texreg(models2,
               ...
               caption = "Table 2 replication (country + year fixed effects and clustered standard errors)",
               label = "tab:tab2twfeclst",
               file = "tables/table2.twfe.clst.tex",
...
tab4.1 <- lfe::felm(as.formula(paste0(mod4.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data[, datafilter]))
#summary(tab4.1)

data4.2 <- data %>% filter(ucdp_0yrs == 1)
tab4.2 <- lfe::felm(as.formula(paste0(mod4.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data4.2[, datafilter]))
#summary(tab4.2)

data4.3 <- data %>% filter(ucdp_1yrs == 1)
tab4.3 <- lfe::felm(as.formula(paste0(mod4.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data4.3[, datafilter]))
#summary(tab4.3)

data4.4 <- data %>% filter(ucdp_2yrs == 1)
tab4.4 <- lfe::felm(as.formula(paste0(mod4.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data4.4[, datafilter]))
#summary(tab4.4)

data4.5 <- data %>% filter(ucdp_3yrs == 1)
tab4.5 <- lfe::felm(as.formula(paste0(mod4.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data4.5[, datafilter]))
#summary(tab4.5)
...
texreg::texreg(models4,
               ...
               caption = "Table 4 replication (country + year fixed effects and clustered standard errors)",
               label = "tab:tab4twfeclst",
               file = "tables/table4.twfe.clst.tex",
               stars = c(0.01, 0.05, 0.1),
               digits = 3)
...
tab5.1 <- lfe::felm(as.formula(paste0(mod5.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data[, datafilter]))
#summary(tab5.1)

data5.2 <- data %>% filter(ucdp_0yrs == 1)
tab5.2 <- lfe::felm(as.formula(paste0(mod5.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data5.2[, datafilter]))
#summary(tab5.2)

data5.3 <- data %>% filter(ucdp_1yrs == 1)
tab5.3 <- lfe::felm(as.formula(paste0(mod5.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data5.3[, datafilter]))
#summary(tab5.3)

data5.4 <- data %>% filter(ucdp_2yrs == 1)
tab5.4 <- lfe::felm(as.formula(paste0(mod5.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data5.4[, datafilter]))
#summary(tab5.4)

data5.5 <- data %>% filter(ucdp_3yrs == 1)
tab5.5 <- lfe::felm(as.formula(paste0(mod5.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data5.5[, datafilter]))
#summary(tab5.5)
...
texreg::texreg(models5,
               ...
               caption = "Table 5 replication (country + year fixed effects and clustered standard errors)",
               label = "tab:tab5twfeclst",
               file = "tables/table5.twfe.clst.tex",
               stars = c(0.01, 0.05, 0.1),
               digits = 3)
...
tab6.1 <- lfe::felm(as.formula(paste0(mod6.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data[, datafilter]))
#summary(tab6.1)

data6.2 <- data %>% filter(ucdp_0yrs == 1)
tab6.2 <- lfe::felm(as.formula(paste0(mod6.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data6.2[, datafilter]))
#summary(tab6.2)

data6.3 <- data %>% filter(ucdp_1yrs == 1)
tab6.3 <- lfe::felm(as.formula(paste0(mod6.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data6.3[, datafilter]))
#summary(tab6.3)

data6.4 <- data %>% filter(ucdp_2yrs == 1)
tab6.4 <- lfe::felm(as.formula(paste0(mod6.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data6.4[, datafilter]))
#summary(tab6.4)

data6.5 <- data %>% filter(ucdp_3yrs == 1)
tab6.5 <- lfe::felm(as.formula(paste0(mod6.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data6.5[, datafilter]))
#summary(tab6.5)
...
texreg::texreg(models6,
               ...
               caption = "Table 6 replication (country + year fixed effects and clustered standard errors)",
               label = "tab:tab6twfeclst",
               file = "tables/table6.twfe.clst.tex",
               stars = c(0.01, 0.05, 0.1),
               digits = 3)
...
tab8.1 <- lfe::felm(as.formula(paste0(mod8.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data[, datafilter]))
#summary(tab8.1)

data8.2 <- data %>% filter(ucdp_0yrs == 1)
tab8.2 <- lfe::felm(as.formula(paste0(mod8.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data8.2[, datafilter]))
#summary(tab8.2)

data8.3 <- data %>% filter(ucdp_1yrs == 1)
tab8.3 <- lfe::felm(as.formula(paste0(mod8.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data8.3[, datafilter]))
#summary(tab8.3)

data8.4 <- data %>% filter(ucdp_2yrs == 1)
tab8.4 <- lfe::felm(as.formula(paste0(mod8.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data8.4[, datafilter]))
#summary(tab8.4)

data8.5 <- data %>% filter(ucdp_3yrs == 1)
tab8.5 <- lfe::felm(as.formula(paste0(mod8.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data8.5[, datafilter]))
#summary(tab8.5)
...
texreg::texreg(models8,
               ...
               caption = "Table 8 replication (country + year fixed effects and clustered standard errors)",
               label = "tab:tab8twfeclst",
               file = "tables/table8.twfe.clst.tex",
               stars = c(0.01, 0.05, 0.1),
               digits = 3)
...
tab9.1 <- lfe::felm(as.formula(paste0(mod9.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data[, datafilter]))
#summary(tab9.1)

data9.2 <- data %>% filter(ucdp_0yrs == 1)
tab9.2 <- lfe::felm(as.formula(paste0(mod9.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data9.2[, datafilter]))
#summary(tab9.2)

data9.3 <- data %>% filter(ucdp_1yrs == 1)
tab9.3 <- lfe::felm(as.formula(paste0(mod9.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data9.3[, datafilter]))
#summary(tab9.3)

data9.4 <- data %>% filter(ucdp_2yrs == 1)
tab9.4 <- lfe::felm(as.formula(paste0(mod9.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data9.4[, datafilter]))
#summary(tab9.4)

data9.5 <- data %>% filter(ucdp_3yrs == 1)
tab9.5 <- lfe::felm(as.formula(paste0(mod9.1, " | ", paste0(xtset, collapse = " + "), " | ", 0, " | ", xtset[1])), data = na.omit(data9.5[, datafilter]))
#summary(tab9.5)
...
texreg::texreg(models9,
               ...
               custom.coef.names = c("Any dem. institution act's",
                                     ...
                                     "Any pol. party act's",
                                     "Any voter act's"),
               caption = "Table 9 replication (country + year fixed effects and clustered standard errors)",
               label = "tab:tab9twfeclst",
               file = "tables/table9.twfe.clst.tex",
               stars = c(0.01, 0.05, 0.1),
               digits = 3)
