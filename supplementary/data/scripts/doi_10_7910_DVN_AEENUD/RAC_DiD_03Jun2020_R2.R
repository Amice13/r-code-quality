...
## Column 1: 	No Fixed Effects or Controls
m1 <- felm(w_ln_zScore ~ crisis*treated | 0 | 0 | indexNumber, data = RAC, subset = (RAC$year >= 2008))

## Column 2: 	No Fixed Effect, with Bank Covariates
m2 <- felm(w_ln_zScore ~ crisis*treated + ln_assets_pre2010 + liquidAssetsToStFunding_pre2010 | 0 | 0 | indexNumber, data = RAC, subset = (RAC$year >= 2008))

## Column 3: 	No Fixed Effect, with Bank and Country Covariates
m3 <- felm(w_ln_zScore ~ crisis*treated + ln_assets_pre2010 + liquidAssetsToStFunding_pre2010 + HHI_pre2010 + gdpPerCapita_pre2010 + LgdpGrowth_pre2010 + L2gdpGrowth_pre2010 + creditToPrivate_pre2010 | 0 | 0 | indexNumber, data = RAC, subset = (RAC$year >= 2008))

## Column 4: 	With Country FE and Bank Covariates
m4 <- felm(w_ln_zScore ~ crisis*treated + ln_assets_pre2010 + liquidAssetsToStFunding_pre2010 | countryIndex | 0 | indexNumber, data = RAC, subset = (RAC$year >= 2008))
